...
export class ProjectModalComponent {
    ...
    protected CreateProject() {
        ...
        this.conService.POST<ProjectResponse>(api_endpoints.project, JSON.stringify(project)).subscribe(res => this.activeModal.close(res))
    }
    ...
    protected UpdateProject() {
        ...
        this.conService.PUT<ProjectResponse>(api_endpoints.project, JSON.stringify(project)).subscribe(res => this.activeModal.close(res))
    }
}
